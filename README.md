...
local Window = OrionLib:MakeWindow({Name = "Darkell Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Darkell Hub"})

OrionLib:MakeNotification({
	Name = "Darkell Hub",
	Content = "Escolha os times?",
...
W:AddLabel("[+] Darkell Hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Darkell Hub(Noitification)",
